...
// Include the header file for the ML_Strategy class.
#include "ML_Strategy.h"

// This is the constructor for the ML_Strategy class. 
// It initializes the member variables of the class to their initial values.
ML_Strategy::ML_Strategy(StrategyID strategyID,
...
// This is the destructor for the ML_Strategy class.
// It does not perform any operations.
ML_Strategy::~ML_Strategy() {
}

void ML_Strategy::DefineStrategyParams() {
}

void ML_Strategy::RegisterForStrategyEvents(StrategyEventRegister* eventRegister, DateType currDate) {
}

void ML_Strategy::OnTrade(const TradeDataEventMsg& msg) {
...
void ML_Strategy::OnOrderUpdate(const OrderUpdateEventMsg& msg) {
...
void ML_Strategy::OnBar(const BarEventMsg& msg) {
}

void ML_Strategy::AdjustPortfolio() {
}

void ML_Strategy::SendOrder(const Instrument* instrument, int trade_size) {
...
void ML_Strategy::OnResetStrategyState() {
}

void ML_Strategy::OnParamChanged(StrategyParam& param) {
}
