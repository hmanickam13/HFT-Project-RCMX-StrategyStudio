...
sleep 1
echo "started StrategyServerBacktesting"
...
./StrategyCommandLine cmd create_instance InstanceName1 Helloworld_Strategy UIUC SIM-1001-101 dlariviere 1000000 -symbols AAPL
...
./StrategyCommandLine cmd start_backtest 2021-11-05 2021-11-05 InstanceName1 0
...
# Below is the original build_strategy.sh file. Uncomment all lines below once.
# #!/bin/bash
# cd /home/vagrant/ss/sdk/RCM/StrategyStudio/examples/strategies/
